...
export class RaceComponent implements OnInit {
  ...
  selectedRaceForModal: any | undefined; 
  ...
  getCountries(): void {
    ...
    if (formattedDate) {
      this.raceService.getCountriesByDate(formattedDate).subscribe(data => {
        this.countries = data;
        this.courses = [];
  ...
  getValues(): void {
    const formattedDate = this.formatDate(this.date);
    if(formattedDate){
      this.raceService.getNatureDayValue(formattedDate).subscribe(data=> {
  ...
  getCourses(): void {
    ...
    if (this.country && formattedDate) {
      this.raceService.getCoursesByCountryAndDate(this.country, formattedDate).subscribe(data => {
        this.courses = data;
        this.raceNumbersAndTimes = [];
        this.raceDetails = [];
      }, error => {
  ...
  getRaceNumbersAndTimes(): void {
    ...
    if (this.country && formattedDate && this.course) {
      this.raceService.getRaceNumbersAndTimes(this.country, formattedDate, this.course).subscribe(data => {
  ...
  getRaceDetails(): void {
    ...
    if (this.country && formattedDate && this.course && this.selectedRaceNumberAndTime) {
      ...
      this.raceService.getDetailsByCountryAndDateAndCourseAndRaceId(this.country, formattedDate, this.course, raceNumber).subscribe(data => {
